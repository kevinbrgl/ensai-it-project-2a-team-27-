...
Ex-libus est une application qui s'associe en même temps à un réseau social et à une bibliothèque de gestion de livres. Elle s'adresse d'un côté à des lecteurs occasionnels, souhaitant seulement suivre l'avancement de leurs lectures et découvrir de nouveaux ouvrages. D'un autre côté, c'est une application interactive qui cible aussi les passionnés souhaitant débattre de leurs lectures, partager leurs avis, créer des playlists pour différentes thématiques et suivre les activités de leurs amis. Afin de garantir le confort de tous, l'application utilise une interface (jsp quel type d'interface).\
...
![Diagramme de classe](img/classe.jpg)
